...
if __name__ == "__main__":
    # print(get_middle_element_of_list([1]) == 1)
    # print(get_middle_element_of_list([1, 2, 3]) == 2)
    # print(get_middle_element_of_list(["a", "b", "c"]) == "b")


    #print(get_middle_part_of_list([1, 2, 3]) == [2])
    #print(get_middle_part_of_list([1, 3]) == [])
    #print(get_middle_part_of_list([1, 3, 6, 7]) == [3, 6])
    #print(get_middle_part_of_list(["a", "b", "b", "a"]) == ["b", "b"])

    #print(create_new_list_with_added_number([1, 2, 3], 4) == [1, 2, 3, 4])

    #print(swap_edge_elements([1, 2, 3]) == [3, 2, 1])
    #print(swap_edge_elements([1, 2]) == [2, 1])
    #print(swap_edge_elements([1, 2, 1, 4]) == [4, 2, 1, 1])
    #print(swap_edge_elements(["foo", "bar", "pub"]) == ["pub", "bar", "foo"])
    
    #print(add_element_in_position([1, 2, 3], 2, 2) == [1, 2, 2, 3])
    #print(add_element_in_position([1], 9, 0) == [9, 1])
    #print(add_element_in_position([1], 9, 1) == [1, 9])

    #print(get_repeated_list([1, 2], 2) == [1, 2, 1, 2])
    #print(get_repeated_list([1], 5) == [1, 1, 1, 1, 1])
